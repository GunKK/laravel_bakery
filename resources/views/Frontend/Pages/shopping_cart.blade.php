						...
						@foreach ( $cart->items as $item )	
							<tr class="cart_item">
								...
								<td class="product-price">
									<span class="amount">{{ number_format($item['item']->promotion_price==0 ? $item['item']->unit_price : $item['item']->promotion_price) }} đ</span>
								</td>
								...
								<td class="product-subtotal">
									<span class="amount">
										{{ number_format(($item['item']->promotion_price==0 ? $item['item']->unit_price : $item['item']->promotion_price) * $item['qty']) }} đ
									</span>
								</td>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="w-100 text-center">
								<img width="img-fluid" src="{{ asset('Frontend/image/cartEmpty.png') }}" alt="">
							</div>
							<div class="text-center">
								<b class="h3 text-warning">Giỏ hàng trống</b>
								<div>
